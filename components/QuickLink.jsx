...
const QuickLink = () => {
  return (
    <div className='w-full pl-page-left h-link-size scroll-smooth bg-linker'>
        <div className='font-popins text-grey font-medium pt-6'>
            ...
            />
            <p className='text-base'>Giving You What You Need</p>
        </div>
        <div className='grid grid-cols-4 text-home-white font-extralight text-xs tracking-wider pt-8'>
            <div>
                <h3 className="text-grey font-normal text-base mb-2">Quick Links</h3>
            ...
            <div>
                <h3 className="text-grey font-popins font-normal text-base mb-2">Company</h3>
            ...
            <div>
                <h3 className="text-grey font-popins font-normal text-base mb-2">Business Hours</h3>
                <p className="font-popins pb-1">Sun-Fri: 9:00-17:00</p>
                <p className="font-popins pb-1">Sat: 10:00-14:00</p>
            </div>
            <div>
                <h3 className="text-grey font-popins font-normal text-base mb-2">Connect with Us</h3>
                <p className="font-popins pb-1">washing@gmail.com</p>
            </div>
        </div>
        <div>
            <div className="text-white pt-12 flex justify-center items-center text-2xl">
            ...
            <div className="flex justify-center items-center pt-8 pb-6">
                <p className="text-grey font-popins font-medium">Copyright © 2023 Washing™</p>
            </div>
